...
export function FAQ() {
  const faqs = [
    ...
    },
    {
      ...
      answer: "First, ensure everyone's safety and call emergency services if needed. Take photos of the damage and exchange details with the other driver. Then contact us immediately on 07591 264731. We'll guide you through the entire process including vehicle recovery and replacement car provision."
    },
    {
